...
const firebaseConfig = {
  apiKey:
    process.env.FIREBASE_API_KEY || 'AIzaSyDUGF6bwt_CtWvZJXkKatATuFU5UL_S3Z8',
  authDomain:
    process.env.FIREBASE_AUTH_DOMAIN || 'graph-chat-fca91.firebaseapp.com',
  ...
  appId:
    process.env.FIREBASE_APP_ID || '1:644040441418:web:d8b8f7b77c8656560330b3',
